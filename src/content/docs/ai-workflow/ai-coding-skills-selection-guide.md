---
title: "AI Coding Skills 怎么选：OMO、superpowers、PUA 与 UI/UX Skill"
description: "从任务复杂度、流程约束和专业能力三个维度，判断什么时候该用多 Agent 工作流、工程流程 Skill 或垂直设计 Skill。"
date: 2026-07-31
...
AI Coding 工具越来越多，最容易犯的错误是把每个插件都装上，然后期待它们自动叠加成更强的能力。现实通常相反：规则互相覆盖、Agent 不知道该听谁的、简单任务也被迫走完一套重流程。

选择 Skill 的核心不是“哪个最强”，而是先判断当前缺的是哪一层能力。
