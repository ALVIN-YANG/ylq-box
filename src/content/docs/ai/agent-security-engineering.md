---
title: "AI Agent 安全工程：Prompt Injection、MCP、权限与数据外泄"
description: "从信任边界出发，系统设计 Agent 的输入隔离、最小权限、审批、MCP 授权、记忆防污染和安全验证。"
date: 2026-07-31
...
聊天模型输出错误，通常只影响一段文本；Agent 输出错误，可能继续调用文件、数据库、浏览器、邮件和生产系统。
