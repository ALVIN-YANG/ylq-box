---
title: "生产级 Agent Tool 设计：Schema、幂等、审批、重试与审计"
description: "模型会选工具，不代表工具可以直接进生产；本文拆解 Agent Tool 从接口定义到副作用控制的完整工程边界。"
date: 2026-07-31
...
Agent 最危险的能力不是生成错误文本，而是拿着错误参数调用一个真实系统。

生产级 Tool 的设计目标不是“让模型能调用”，而是：
